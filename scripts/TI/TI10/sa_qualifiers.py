...
league_id = 13256
teams = [
            'NoPing Esports', 'EGOBOYS', 'Infamous Gaming', 'Unknown Team', 'Hokori', 'Latam Defenders',
            'SG esports', 'Interitus', 'Infinity', 'BINOMISTAS', 'Omega Gaming', 'Inverse'
        ] 

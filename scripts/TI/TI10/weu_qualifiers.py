...
save_file_path = "..\\..\\..\\data\\TI\\TI10\\WEU_Qualifiers\\{}"
dfs_to_convert = {}
jsons_to_upload = {}
...
league_id = 13256
teams = [
            'Into The Breach', 'Spider Pigzs', 'Ghost Frogs', 'ViKin.gg', 'Chicken Fighters', 'Hellbear Smashers', 
            'Tundra Esports', 'Brame', 'Hippomaniacs', 'No Bounty Hunter', 'Team Liquid', 'OG', 'Nigma', 'Team Bald Reborn'
        ] 

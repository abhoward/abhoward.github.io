...
save_file_path = "..\\..\\..\\data\\TI\\TI10\\SEA_Qualifiers\\{}"
dfs_to_convert = {}
jsons_to_upload = {}
...
league_id = 13256
teams = [
            'Execration', 'Team SMG', 'Fnatic', 'TNC Predator', 'Motivate.Trust Gaming', 'BOOM Esports', 'Galaxy Racer Esports',
            'OB.Neon', 'Cignal Ultra', 'Ωmega Esports', 'Lilgun', '496 Gaming', 'Army Geniuses', 'Team Mystery', 'South Built Esports'
        ] 

...
save_file_path = "..\\..\\..\\data\\TI\\TI10\\CN_Qualifiers\\{}"
dfs_to_convert = {}
jsons_to_upload = {}
...
league_id = 13256
teams = [
            'Royal Never Give Up', 'phoenix gaming', 'Aster.Aries', 'Elephant', 'Team Magma', 'EHOME', 
            'Sparking Arrow Gaming', 'Xtreme  Gaming', 'CDEC', 'LBZS'
        ] 
